...
function socket_connection() {
  ...
  document.getElementById("status").innerHTML =
    "Connection Request send. Waiting response";
  ...
  socket.on("data_received", function (prices_data) {
    ...
    else document.getElementById(key + "_VOL").innerHTML = prices_data.v;
  ...
  socket.on("successfully", (message) => {
    ...
    if (socket_re_conn !== undefined) clearTimeout(socket_re_conn);
  });
  ...
  /* 
	...
	*/
  if (heart_interval !== undefined) clearTimeout(heart_interval);
