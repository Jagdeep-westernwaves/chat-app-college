        ...
        <>
          ...
          >
            ...
            <Row>
              <Col span={24}>
                <Form.Item name="remember" valuePropName="checked">
                  ...
                  <span className="form-agreelable" to="/about">
                    I agree to the
                    <NavLink className="form-links" to="/about">
                      {" "}
                      privacy policy
                    </NavLink>
                    .
            ...
            <Form.Item>
              <Row>
                <Col span={24}>
                  <span className="form-label" to="/about">
